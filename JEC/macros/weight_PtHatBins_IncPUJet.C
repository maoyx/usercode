...
void weight_PtHatBins_IncPUJet(const char *infile="input.root", const char *outfile = "output.root",float maxpthat=30., float xSection=1.,bool updateCorrections=true)
{
  ...
  //FactorizedJetCorrector *_JEC_HI44X= new JetCorrectorParameters("YYYY.txt"); 
    if(updateCorrections){   
     ...
     // L2Name = "/net/hidsk0001/d00/scratch/maoyx/pPb/CMSSW_5_3_8_HI_patch2/src/MNguyen/JEC/JEC_dijet_L2Relative_"+corrFileName[idir]+".txt";
      L2Name = "/net/hidsk0001/d00/scratch/maoyx/pPb/CMSSW_5_3_8_HI_patch2/src/MNguyen/JEC/JEC_"+calgo[idir]+"_L2Relative_"+corrFileName[idir]+".txt";
     ...
     // L3Name = "/net/hidsk0001/d00/scratch/maoyx/pPb/CMSSW_5_3_8_HI_patch2/src/MNguyen/JEC/JEC_dijet_L3Absolute_"+corrFileName[idir]+".txt";
      L3Name = "/net/hidsk0001/d00/scratch/maoyx/pPb/CMSSW_5_3_8_HI_patch2/src/MNguyen/JEC/JEC_"+calgo[idir]+"_L3Absolute_"+corrFileName[idir]+".txt";
